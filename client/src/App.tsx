...
import DistrictSetup from "@/pages/onboarding/district-setup";
import RigorPolicyConfig from "@/pages/onboarding/rigor-policy-config";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/onboarding/district-setup" component={() => <ProtectedRoute component={DistrictSetup} />} />
      <Route path="/onboarding/rigor-policy-config" component={() => <ProtectedRoute component={RigorPolicyConfig} />} />
